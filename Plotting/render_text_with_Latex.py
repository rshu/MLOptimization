...
# Latex engine will interpret the raw string
# first, the equation for 's'
plt.annotate(r'$\cos(4 \times \pi \times {t}) \times \sin(\pi \times \frac {t} 4) + 2$', xy=(.9, 2.2), xytext=(.5, 2.6),
...
# some ranges...
plt.text(.01, 2.1,
         r'Ranges: $( a ), [ b ], \{ c \}, | d |, \| e \|, \langle f \rangle, \lfloor g \rfloor, \lceil h \rceil$')
