...
# min_samples_left, 1, [1, 20], The minimum number of samples required to be at a leaf node.
...
def rffunction(n_tree, max_depth):
    rf = RandomForestRegressor(n_estimators=n_tree, max_depth=max_depth, random_state=42)
